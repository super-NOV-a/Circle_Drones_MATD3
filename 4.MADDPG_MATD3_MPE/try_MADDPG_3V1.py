...
Env_name = 'c3v1a'  # c3v1\c3v1a\c3v1p  # MADDPG训练的模型
...
Success_FollowDistance = 0.3      # 成功靠近目标距离: 1。跟踪敌机的距离 胜利条件
...
class Runner:
    def __init__(self, args):
        ...
        for agent_id in range(self.args.N_drones):
            model_path = "./model/model/{}/{}_actor_mark_{}_number_{}_step_{}k_agent_{}.pth".format(self.env_name,
                                                                                              self.args.algorithm,
