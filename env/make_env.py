...
def make_env(scenario_name, benchmark=False, Discrete = False):
    ...
    Use env.render() to observation_field the environment on the screen.
    ...
    if benchmark:        
        ...
        env = MultiAgentEnv(world, scenario.reset_world, scenario.reward, scenario.observation, scenario_name=scenario_name, Discrete=Discrete)
    return env
